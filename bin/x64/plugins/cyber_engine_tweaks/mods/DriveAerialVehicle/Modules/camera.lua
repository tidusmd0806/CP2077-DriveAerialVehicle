...
function Camera:SetPerspective()
    TweakDB:SetFlat(TweakDBID.new("Camera.VehicleTPP_4w_Preset_High_Close.baseBoomLength"), self.default_high_close_distance * self.all_models[DAV.model_index].camera_distance_ratio[DAV.seat_index])
    TweakDB:SetFlat(TweakDBID.new("Camera.VehicleTPP_4w_Preset_High_Close.boomLengthOffset"), self.default_high_close_distance_offset * self.all_models[DAV.model_index].camera_distance_ratio[DAV.seat_index])
    TweakDB:SetFlat(TweakDBID.new("Camera.VehicleTPP_4w_Preset_High_Close.lookAtOffset"), Vector3.new(self.all_models[DAV.model_index].camera_center_offset[DAV.seat_index].x, self.all_models[DAV.model_index].camera_center_offset[DAV.seat_index].y, self.all_models[DAV.model_index].camera_center_offset[DAV.seat_index].z))
    TweakDB:SetFlat(TweakDBID.new("Camera.VehicleTPP_4w_Preset_Low_Close.baseBoomLength"), self.default_low_close_distance * self.all_models[DAV.model_index].camera_distance_ratio[DAV.seat_index])
    TweakDB:SetFlat(TweakDBID.new("Camera.VehicleTPP_4w_Preset_Low_Close.boomLengthOffset"), self.default_low_close_distance_offset * self.all_models[DAV.model_index].camera_distance_ratio[DAV.seat_index])
    TweakDB:SetFlat(TweakDBID.new("Camera.VehicleTPP_4w_Preset_Low_Close.lookAtOffset"), Vector3.new(self.all_models[DAV.model_index].camera_center_offset[DAV.seat_index].x, self.all_models[DAV.model_index].camera_center_offset[DAV.seat_index].y, self.all_models[DAV.model_index].camera_center_offset[DAV.seat_index].z))
    TweakDB:SetFlat(TweakDBID.new("Camera.VehicleTPP_4w_Preset_High_Medium.baseBoomLength"), self.default_high_medium_distance * self.all_models[DAV.model_index].camera_distance_ratio[DAV.seat_index])
    TweakDB:SetFlat(TweakDBID.new("Camera.VehicleTPP_4w_Preset_High_Medium.boomLengthOffset"), self.default_high_medium_distance_offset * self.all_models[DAV.model_index].camera_distance_ratio[DAV.seat_index])
    TweakDB:SetFlat(TweakDBID.new("Camera.VehicleTPP_4w_Preset_High_Medium.lookAtOffset"), Vector3.new(self.all_models[DAV.model_index].camera_center_offset[DAV.seat_index].x, self.all_models[DAV.model_index].camera_center_offset[DAV.seat_index].y, self.all_models[DAV.model_index].camera_center_offset[DAV.seat_index].z))
    TweakDB:SetFlat(TweakDBID.new("Camera.VehicleTPP_4w_Preset_Low_Medium.baseBoomLength"), self.default_low_medium_distance * self.all_models[DAV.model_index].camera_distance_ratio[DAV.seat_index])
    TweakDB:SetFlat(TweakDBID.new("Camera.VehicleTPP_4w_Preset_Low_Medium.boomLengthOffset"), self.default_low_medium_distance_offset * self.all_models[DAV.model_index].camera_distance_ratio[DAV.seat_index])
    TweakDB:SetFlat(TweakDBID.new("Camera.VehicleTPP_4w_Preset_Low_Medium.lookAtOffset"), Vector3.new(self.all_models[DAV.model_index].camera_center_offset[DAV.seat_index].x, self.all_models[DAV.model_index].camera_center_offset[DAV.seat_index].y, self.all_models[DAV.model_index].camera_center_offset[DAV.seat_index].z))
    TweakDB:SetFlat(TweakDBID.new("Camera.VehicleTPP_4w_Preset_High_Far.baseBoomLength"), self.default_high_far_distance * self.all_models[DAV.model_index].camera_distance_ratio[DAV.seat_index])
    TweakDB:SetFlat(TweakDBID.new("Camera.VehicleTPP_4w_Preset_High_Far.boomLengthOffset"), self.default_high_far_distance_offset * self.all_models[DAV.model_index].camera_distance_ratio[DAV.seat_index])
    TweakDB:SetFlat(TweakDBID.new("Camera.VehicleTPP_4w_Preset_High_Far.lookAtOffset"), Vector3.new(self.all_models[DAV.model_index].camera_center_offset[DAV.seat_index].x, self.all_models[DAV.model_index].camera_center_offset[DAV.seat_index].y, self.all_models[DAV.model_index].camera_center_offset[DAV.seat_index].z))
    TweakDB:SetFlat(TweakDBID.new("Camera.VehicleTPP_4w_Preset_Low_Far.baseBoomLength"), self.default_low_far_distance * self.all_models[DAV.model_index].camera_distance_ratio[DAV.seat_index])
    TweakDB:SetFlat(TweakDBID.new("Camera.VehicleTPP_4w_Preset_Low_Far.boomLengthOffset"), self.default_low_far_distance_offset * self.all_models[DAV.model_index].camera_distance_ratio[DAV.seat_index])
    TweakDB:SetFlat(TweakDBID.new("Camera.VehicleTPP_4w_Preset_Low_Far.lookAtOffset"), Vector3.new(self.all_models[DAV.model_index].camera_center_offset[DAV.seat_index].x, self.all_models[DAV.model_index].camera_center_offset[DAV.seat_index].y, self.all_models[DAV.model_index].camera_center_offset[DAV.seat_index].z))
end
