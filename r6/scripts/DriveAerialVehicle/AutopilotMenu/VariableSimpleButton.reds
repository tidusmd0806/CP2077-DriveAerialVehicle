...
public class VariableSimpleButton extends CustomButton {
    ...
    protected let m_size_width: Float = 400.0;
    protected let m_size_height: Float = 100.0;

    protected func CreateWidgets() {
        let root: ref<inkCanvas> = new inkCanvas();
        root.SetName(n"button");
        root.SetSize(this.m_size_width, this.m_size_height);
    ...
    public static func Create(width: Float, Height: Float) -> ref<VariableSimpleButton> {
        let self: ref<VariableSimpleButton> = new VariableSimpleButton();
        self.m_size_width = width;
        self.m_size_height = Height;
        self.CreateInstance();
