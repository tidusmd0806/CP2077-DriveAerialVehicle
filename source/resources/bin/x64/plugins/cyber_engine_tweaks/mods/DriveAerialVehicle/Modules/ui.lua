...
function UI:CreateNativeSettingsPage()
	...
	option_table = DAV.NativeSettings.addRangeInt("/DAV/advance", DAV.core_obj:GetTranslationText("native_settings_advance_horizontal_air_resistance_const"), DAV.core_obj:GetTranslationText("native_settings_advance_horizontal_air_resistance_const_description"), 0, 100, 1, self:InternalToUserValue(DAV.user_setting_table.horizontal_air_resistance_const, 0.000, 0.040), self:InternalToUserValue(0.015, 0.000, 0.040), function(value)
		DAV.user_setting_table.horizontal_air_resistance_const = self:UserToInternalValue(value, 0.000, 0.040)
		Utils:WriteJson(DAV.user_setting_path, DAV.user_setting_table)
		Cron.After(self.delay_updating_native_settings, function()
			self:UpdateNativeSettingsPage()
		end)
	...
	if self.selected_flight_mode_index == 1 then
		option_table = DAV.NativeSettings.addRangeInt("/DAV/advance", DAV.core_obj:GetTranslationText("native_settings_advance_acceleration"), DAV.core_obj:GetTranslationText("native_settings_advance_acceleration_description"), 1, 100, 1, self:InternalToUserValue(DAV.user_setting_table.acceleration, 0.01, 3.00), self:InternalToUserValue(1.50, 0.01, 3.00), function(value)
		...
		option_table = DAV.NativeSettings.addRangeInt("/DAV/advance", DAV.core_obj:GetTranslationText("native_settings_advance_vertical_acceleration"), DAV.core_obj:GetTranslationText("native_settings_advance_vertical_acceleration_description"), 1, 100, 1, self:InternalToUserValue(DAV.user_setting_table.vertical_acceleration, 0.01, 3.00), self:InternalToUserValue(1.50, 0.01, 3.00), function(value)
	...
	elseif self.selected_flight_mode_index == 2 then
		...
		option_table = DAV.NativeSettings.addRangeInt("/DAV/advance", DAV.core_obj:GetTranslationText("native_settings_advance_h_acceleration"), DAV.core_obj:GetTranslationText("native_settings_advance_h_acceleration_description"), 1, 100, 1, self:InternalToUserValue(DAV.user_setting_table.h_acceleration, 0.01, 2.00), self:InternalToUserValue(1.00, 0.01, 2.00), function(value)
